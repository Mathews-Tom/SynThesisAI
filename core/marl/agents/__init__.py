...
This module provides the base RL agent framework and specialized agent implementations
for multi-agent reinforcement learning coordination in the SynThesisAI platform.
"""
